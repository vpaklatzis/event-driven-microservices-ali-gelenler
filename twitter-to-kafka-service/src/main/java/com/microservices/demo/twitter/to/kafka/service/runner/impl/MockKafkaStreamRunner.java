...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    public void start() throws TwitterException {
        ...
        log.info("Starting filtering process of mock twitter streams for keywords {}", Arrays.toString(keywords));
    ...
    private void sleep(long sleepTimeMs) {
        try {
            ...
            throw new TwitterToKafkaServiceException("Error occurred while sleeping and waiting for the new status");
        }
    }
